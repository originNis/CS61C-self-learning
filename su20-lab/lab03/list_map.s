...
recurse:
    ...
    # THINK: why a0?
    # Answer: default parameters utilized by callee function is stored in registers aX, and a0 as the first parameter denotes the value of node.
    ### YOUR CODE HERE ###
    lw a0, 0(s0)
    ...
    # Answer: function returns is stored in a0 by default.
    ### YOUR CODE HERE ###
    sw a0, 0(s0)
    ...
    # Answer: address of function is the 2nd parameter in sample C code.
    ### YOUR CODE HERE ###
	add a1, s1, x0
